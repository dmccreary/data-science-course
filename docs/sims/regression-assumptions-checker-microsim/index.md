...
description: Interactive p5.js MicroSim for regression assumptions checker microsim.
...
[Run the Regression Assumptions Checker MicroSim MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
