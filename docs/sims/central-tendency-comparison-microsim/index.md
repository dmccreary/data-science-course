...
description: Interactive p5.js MicroSim for central tendency comparison microsim.
...
[Run the Central Tendency Comparison MicroSim MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
