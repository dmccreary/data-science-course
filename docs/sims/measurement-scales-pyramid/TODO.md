...
**MicroSim:** measurement-scales-pyramid
...
- **Framework:** p5.js
- **Detected subjects:** Mathematics, Physics, Computer Science, Statistics, Engineering
- **Visualization types:** graph, interactive-demo, network, map
- **Has main.html:** Yes
- **Has index.md:** Yes
