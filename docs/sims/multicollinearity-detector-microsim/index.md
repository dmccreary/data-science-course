...
description: Interactive p5.js MicroSim for multicollinearity detector microsim.
...
[Run the Multicollinearity Detector MicroSim MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
