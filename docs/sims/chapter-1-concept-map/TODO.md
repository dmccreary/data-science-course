...
**MicroSim:** chapter-1-concept-map
...
- **Detected subjects:** Mathematics, Physics, Computer Science, Chemistry, Statistics
- **Visualization types:** animation, simulation, graph, interactive-demo, network, map
- **Has main.html:** Yes
- **Has index.md:** Yes
