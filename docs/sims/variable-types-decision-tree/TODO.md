...
**MicroSim:** variable-types-decision-tree
**Repository:** data-science-course
...
- **Framework:** mermaid
- **Detected subjects:** Mathematics, Computer Science, Chemistry, Biology, Statistics
- **Visualization types:** chart, graph, diagram, interactive-demo, network, map
- **Has main.html:** Yes
- **Has index.md:** Yes
