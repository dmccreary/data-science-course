...
- [Variable Types Decision Tree](../variable-types-decision-tree/) - Visual flowchart for classifying variables
- [Introduction to Data Science](../../chapters/01-intro-to-data-science/) - Chapter covering data types
