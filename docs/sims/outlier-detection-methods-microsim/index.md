...
description: Interactive p5.js MicroSim for outlier detection methods microsim.
...
[Run the Outlier Detection Methods MicroSim MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
