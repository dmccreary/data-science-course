...
| 5 | Chapter Quizzes | 0 / 14 | Recommended | Chapters with a quiz.md (0 questions total) |
| 6 | Chapter References | 0 / 14 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 295 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 0 | Recommended | Questions in faq.md |
| 9 | Words | 85,580 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 75 | 75 | H4 headers starting with '#### Diagram:' |
| Equations | 134 | 121 | LaTeX expressions (inline and display) |
| Total Words | 85,580 | 49,562 | Words in markdown files |
| Links | 197 | 35 | Hyperlinks in markdown format |
| Equivalent Pages | 371 | 226 | Estimated pages (250 words/page + visuals) |
