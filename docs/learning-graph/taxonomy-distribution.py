...
def analyze_taxonomy_distribution(csv_path: str, output_path: str, taxonomy_names: dict = None):
    ...
    """
    # Default taxonomy names for data science course
    default_names = {
    ...
    with open(output_path, 'w', encoding='utf-8') as f:
        ...
        if over_represented:
            f.write("### Over-Represented Categories (>30%)\n\n")
        ...
        if under_represented:
            f.write("### Under-Represented Categories (<3%)\n\n")
        ...
        if spread < 15:
            ...
            f.write("- **Consider rebalancing**: Large spread between categories ({:.1f}%)\n".format(spread))
        ...
        if misc_pct < 2:
            ...
            f.write(f"- **MISC category has {misc_count} concepts**: Review for better categorization\n")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        ...
        print("\nExample:")
        print("  python taxonomy-distribution.py learning-graph.csv taxonomy-distribution.md")
        sys.exit(1)
